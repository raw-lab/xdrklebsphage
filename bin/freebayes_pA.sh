...
#SBATCH --job-name=freebayes-Klebs-phages
#SBATCH --nodes=1
...
#bwa mem -t $CPUS ./ref_gen_pA/phageA $1 $2 | samtools sort -@2 -o $(basename $1 .fasta)_sorted.bam -
...
freebayes -f ./ref_gen_pA/phageA.fasta -p 1 $(basename $1 .fasta)_sorted.bam > $(basename $1 .fasta)_FB.vcf
